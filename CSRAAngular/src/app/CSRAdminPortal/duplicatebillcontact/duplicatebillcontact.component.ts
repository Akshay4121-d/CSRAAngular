...
@Component({
  selector: 'app-duplicatebillcontact',
  templateUrl: './duplicatebillcontact.component.html',
  styleUrls: ['./duplicatebillcontact.component.css']
})
export class DuplicatebillcontactComponent implements OnInit {
  ...
  GoToSearch(data:any)
  {
    ...
    "&PolicyNo=" + this.common.encrypt(this.l_Policyno) + "&requestType="+this.common.encrypt("duplicatebill") +
  ...
  {
    debugger;
    let url = AppConstants.SERVICE_URL + 'PolicyInformation/GetReceipientRole?requestType=' + this.common.encrypt('duplicatebill');
